# My original solution to challenge 31 began to break down at 3 ms. This modified solution works by
# increasing the number of processes running plus increasing the number of tests to 10 to get a better average
# To test it, run chall31_server.py with the reduced sleep time, then run this.
